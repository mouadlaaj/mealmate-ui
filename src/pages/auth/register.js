        ...
        <div className="flex min-h-0 w-full flex-1 flex-col items-center justify-center overflow-hidden">
          ...
          >
            ...
            <p className="mb-2 max-w-[360px] text-center text-[0.7rem] font-normal leading-relaxed opacity-90 lg:text-[0.8rem] xl:text-[0.9rem]">
              Create your account to plan meals, track nutrition, and stay healthy.
            </p>
        ...
        >
          <div className="w-full rounded-2xl bg-transparent p-0 sm:bg-white sm:p-6 sm:shadow-[0_8px_30px_rgba(11,95,255,0.08)]">
            ...
            <div className="mb-6 text-center sm:mb-7">
              <h2 className="text-lg font-bold text-[#0A2E6B] sm:text-xl">Create Account</h2>
              <p className="mt-1 text-xs text-[#5C7299] sm:text-sm">
                Sign up to start your Meal Mate journey
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-3.5 sm:gap-4">
              <motion.div
                ...
                className="flex flex-col gap-3.5 sm:flex-row sm:gap-4"
              >
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    value={form.lastName}
                    onChange={handleChange}
                    className="w-full rounded-lg border border-[#C7D7EE] bg-white py-2 px-3 text-sm text-left outline-none transition-colors hover:border-[#0B5FFF] focus:border-2 focus:border-[#0B5FFF] sm:py-2.5"
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="mt-1 text-left text-[0.7rem] text-[#5C7299]">
